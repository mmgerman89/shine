...
CREATE TABLE users (
    ...
    created_at timestamp without time zone NOT NULL,
    updated_at timestamp without time zone NOT NULL,
    CONSTRAINT email_must_be_company_email CHECK (((email)::text ~* '^[^@]+@man\.com'::text))
);
...
INSERT INTO schema_migrations (version) VALUES ('20160723222923'), ('20160725015224'), ('20160725230028'), ('20160822004543');
